...
const roleHierarchy: Record<UserRole, number> = {
  [UserRole.ADMIN]: 100,
  [UserRole.CONTENT_ADMIN]: 90,
  [UserRole.INSTITUTION]: 80,
  [UserRole.BOOK_MANAGER]: 70,
  [UserRole.STORY_MANAGER]: 65,
  [UserRole.TEACHER]: 60,
  [UserRole.WRITER]: 40,
  [UserRole.LEARNER]: 20,
};
...
export function getRoleDashboardUrl(role: UserRole): string {
  const dashboardUrls: Record<UserRole, string> = {
    ...
    [UserRole.WRITER]: '/dashboard/writer',
  };
...
export const permissions = {
  // Content management
  canCreateStory: [UserRole.ADMIN, UserRole.TEACHER, UserRole.WRITER],
...
export function formatRoleName(role: UserRole): string {
  const roleNames: Record<UserRole, string> = {
    ...
    [UserRole.BOOK_MANAGER]: 'Book Manager',
    [UserRole.STORY_MANAGER]: 'Story Manager',
...
export function getRoleBadgeColor(role: UserRole): string {
  const roleColors: Record<UserRole, string> = {
    ...
    [UserRole.CONTENT_ADMIN]: 'bg-indigo-100 text-indigo-800 border-indigo-200',
    [UserRole.BOOK_MANAGER]: 'bg-orange-100 text-orange-800 border-orange-200',
    [UserRole.STORY_MANAGER]: 'bg-yellow-100 text-yellow-800 border-yellow-200',
    ...
    [UserRole.WRITER]: 'bg-pink-100 text-pink-800 border-pink-200',
  };
