...
/**
 * Secure NextAuth adapter with proper authentication context
 * This wraps the PrismaAdapter and overrides key methods to use secure authentication context
 */
export function createSecureAuthAdapter(): Adapter {
  ...
  return {
    ...
    async createUser(user: Omit<AdapterUser, "id">) {
      return executeWithAuthContext(async (client) => {
